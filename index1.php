      ...
      <div class="form-group"> 
        <table class="table table-striped table-condensed" id = "tableau">  
          <tr>
            ...
            <?php
              $con = getConnection();
              $sql ="SELECT * FROM logement ORDER BY nom_logement "; 
          ...
          <tbody>
            <tr>
              ...
              <td><?php echo $row['nom_logement'] ;?></td>
              <td><?php echo $row['description'] ;?></td>
              <td> 
                <a href="editerlog.php?id=<?php echo $row['id_logement'] ;?>" class = "btn btn-info btn-xs add_data" >Edit</a>
                <a href="deletelog.php?id=<?php echo $row['id_logement'] ;?>" class = "btn btn-danger btn-xs add_data">Delete</a>
              </td>
            </tr>
          </tbody>
          <?php  
